...
class CodeBox {
  ...
  public data:   CodeboxData;

  private highlightScriptID: string;
  private highlightCSSID:    string;
  private codeArea:          HTMLElement;
  private selectInput:       HTMLElement;
  private selectDropIcon:    HTMLElement;
  ...
  _createLanguageSelectElement(){
    ...
    const languages = this.config.languages || Object.entries(COMMON_LANGUAGES);
